...
class MainService : LifecycleService() {
    ...
    private fun connectUsb() {
        ...
        if (driver == null) { updateUsbStatus("USB: Disconnected"); scheduleUsbReconnect(); return }
    ...
    private fun closeSerial(status: String?) {
        synchronized(usbLock) {
            ...
            status?.let { newStatus ->
                ...
                if (newStatus.contains("failed") || newStatus.contains("Disconnected")) { scheduleUsbReconnect() }
    ...
    companion object {
        ...
        const val ACTION_USB_PERMISSION = "com.roverlink.USB_PERMISSION"
